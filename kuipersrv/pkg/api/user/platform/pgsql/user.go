...
func (u User) Create(db orm.DB, usr kuiper.User) (kuiper.User, error) {
	...
	if err == nil || err != pg.ErrNoRows {
		return kuiper.User{}, ErrAlreadyExists
	}
...
func (u User) List(db orm.DB, qp *kuiper.ListQuery, p kuiper.Pagination) ([]kuiper.User, error) {
	var users []kuiper.User
...
func (u User) Delete(db orm.DB, user kuiper.User) error {
